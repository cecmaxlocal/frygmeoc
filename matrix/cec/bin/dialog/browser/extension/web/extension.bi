...
Const KWebSite As Double = 10.0        ' Carrying capacity
Const rWebSite As Double = 0.7         ' Growth rate

'' Function to compute next generation population using logistic growth formula
Function NextPopulationWebSite(P As Double) As Double
    Return P + r * P * (1 - P / K)
End Function

'' Sub to simulate and print population over iterations starting at P0=18
Sub SimulateWebSite(iterations As Integer)
...
Dim WebSite As Integer = 27512

SimulateWebSite(WebSite)
' ```
