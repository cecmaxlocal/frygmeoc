...
Const KPackages As Double = 10.0        ' Carrying capacity
Const rPackages As Double = 0.7         ' Growth rate

'' Function to compute next generation population using logistic growth formula
Function NextPopulationPackages(P As Double) As Double
    Return P + r * P * (1 - P / K)
End Function

'' Sub to simulate and print population over iterations starting at P0=18
Sub SimulatePackages(iterations As Integer)
...
Dim Packages As Integer = 27512

SimulatePackages(Packages)
' ```
