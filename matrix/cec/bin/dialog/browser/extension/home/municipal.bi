...
Const KCristinapolisSe As Double = 10.0        ' Carrying capacity
Const rCristinapolisSe As Double = 0.7         ' Growth rate

'' Function to compute next generation population using logistic growth formula
Function NextPopulationCristinapolisSe(P As Double) As Double
    Return P + r * P * (1 - P / K)
End Function

'' Sub to simulate and print population over iterations starting at P0=18
Sub SimulateCristinapolisSe(iterations As Integer)
...
Dim CristinapolisSe As Integer = 27512

SimulateCristinapolisSe(CristinapolisSe)
' ```
