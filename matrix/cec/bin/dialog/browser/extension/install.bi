...
Const KInput As Double = 10.0        ' Carrying capacity
Const rInput As Double = 0.7         ' Growth rate

'' Function to compute next generation population using logistic growth formula
Function NextPopulationInput(P As Double) As Double
    Return P + r * P * (1 - P / K)
End Function

'' Sub to simulate and print population over iterations starting at P0=18
Sub SimulateCobweb(iterations As Integer)
