...
DIM As Integer P0Human
DIM As Integer P1Human
DIM As Integer P2Human

P0Human = PtDSL(27512) * PtDSL(1 / 2) + PtDSL(27512) / PtDSL(100000)
P1Human = PtDSL(27512) * PtDSL(1 / 2) + PtDSL(27512) / PtDSL(100000)
P2Human = PtDSL(27512) * PtDSL(1 / 2) + PtDSL(27512) / PtDSL(100000)
...
Declare Function ParabolaLine (p1 As Templar, p2 As Templar)
